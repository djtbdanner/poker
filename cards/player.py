...
class Player:
    def __init__(self, name="A Player with no name", hand = None, playerId = None,  chips=100, dealer=False, folded = False, currentBet = 0, currentAction=PlayerAction.NONE, turn=False, turnStartTime=None):
